...
public class ListWarkopActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private class ViewPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            return new ListWarkopFragment(position);
        }
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.warkop1_menu, menu);
        return true;
    }
